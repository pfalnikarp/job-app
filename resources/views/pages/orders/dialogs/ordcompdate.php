...
<div id="ordercompdatedialog" style="display:none;">
  ...
  <!--  {!! Form::label('order_date', 'Order Date(India)', ['class' => 'control-label']) !!} -->
   ...
   <input type="text" id= "ord_comp_date" name="ord_comp_date" value="">
 ...
 <input type="hidden" class="ordercompdateid" name="id" id="id" value=0 />
