...
<input type="hidden" name="company_id" value="{{$client->company_id}}">
 <div class="row mt-1 mb-1">
    ...
    <div class="col-md-9">
        <a href="{{route('clients.index')}}" class="btn btn-danger btn-outline rightdiv ml-2">Cancel</a>
      @permission('client.update')
        <a href="{{route('clients.edit',['id'=>$client->id])}}" class="btn btn-primary btn-outline  rightdiv">Edit</a>
      @endpermission
   ...
   <div class="col-md-5 px-2">
    <div class="rounded border border-fill s">
      <div class="card-body">
        ...
        <h5><label class="labviewcolor">Company Id : </label>
        <span class="spantext">{{$client->company_id}}</span></h5>
