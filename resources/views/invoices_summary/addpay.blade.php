        ...
        <div class="card-body">
            ...
            <fieldset>
                ...
                <div class="row form-group">
                    ...
                    <div class="form-group col-md-2">
                        {!! Form::label('Net Amount', 'Net Amount', ['class' => 'control-label ']) !!}

                        {!! Form::text('net_amt', $invoicesummary->net_amt,  ['class' => 'form-control iamt' , 'readonly' => 'true']) !!}
                    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(".convrt").change(function () {
                ...
                var recinr = parseFloat(convrt) * parseFloat(amtpaid);
