...
<body>
  ...
  <header> 
    <div class="row">  <img src="img/invoice-tom.png" alt="Logo" width="100%" class="logo"/> </div>
         @if( $pagecount>0)
        <div class="row">
                  @php $n++; @endphp
  ...
  <main>
   ...
   @if($pagecount == 0)
      ...
      <div class="col-xs-4"  style="float:left;">
       ...
       <div class="col-xs-2">
         ...
         <div class="col-xs-4" style="float:right;">
            ...
            <b>Invoices from 01-03-2021 to 31-03-2021</b>    
            </span>
         </div>
    ...
    <div class="row">
         <div class="col-xs-3" style="text-align:bottom;">
            <h3>Bill To</h3>
         ...
         <div class="col-xs-3 " style="text-align:right;" >
          ...
          <div class="col-xs-3 " >
                 <img src="img/tomupicode.jpg" alt="Logo" width="100%" class="logo"/>
         </div>
  </div>
   ...
   @endif
    ...
    @foreach($orderlist as $key)
                ...
                <div class="row col-xs-12">
                  ...
                  <span class="col-xs-2">Order ID</span>
    ...
    @if($n % 30 == 0 || $n % 31 == 0 || $n % 32 == 0 || $n % 33 == 0)
           
         
          <div class="row">   @php $n=1;  $n++; @endphp  </div>
