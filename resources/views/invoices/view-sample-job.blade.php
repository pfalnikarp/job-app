...
<style>
    ...
    .footr { position: absolute; bottom: -60px; left: 0px; right: 0px;  
      height: 200px; }  
...
@php $totaldue =0; $discount = 10;  @endphp

    @php  $totaldue = $totaldue + (float)$ordersumfp; @endphp


<div class="row firstpage1">
  @if($pagecount == 0)
      ...
      <div class="col-xs-4"  style="float:left;">
       ...
       <div class="col-xs-2">
         ...
         <div class="col-xs-4" style="float:right;">
            ...
            <span>
            Invoice no:   {{ $key->invoice_no }}<br>
            Invoice date: {{ date('d-M-Y', strtotime($key->invoice_dt)) }} <br>
            Due date:     {{ $due_dt }}  <br>
      Orders from {{ $pfr_dt }} to {{ $pto_dt }} 
            </span>
               @php  $discount = $key->discount; @endphp 
            @endforeach
         </div>
    ...
    <div class="row" >
         ...
         <div id="rcorners3" class="col-xs-2"  >
           
            <h3> Amount Due <br>  $ {{ $totaldue - $discount}}  USD
            </h3>
         </div>
        ...
        <!--   <div class="col-xs-3"  style="text-align:center;">
                 <img src="img/tomupicode.jpg" alt="Logo" width="95%" height="55%" class="logo"/>
         </div> -->
 ...
 <br>
  ...
  <!--  <div class="row minformation">
    ...
    <div class="row minformationh">
        ...
        <div class="col-xs-3">
            @if( $discount > 0 )
             {{ number_format($totaldue  - $discount,2) }}
            @else
                 {{ number_format($totaldue ,2) }}
            @endif
        </div>
    ...
    <table width="100%" class="detail">
        ...
        <tr>
            ...
            <th  style="text-align: left;">File Name</th>
             ...
             <th  style="text-align: right;">File Price</th>
        </tr>
        </thead>
        <tbody>
            
              @php  $client_name = ''; $order_id =1; $n=1; $fileno=1;  $pagecount++; @endphp
            ...
            @foreach ($orderlist as $key )
                ...
                @php      
                         ...
                         $filecount = $key->file_count;
                          $stiches =  (int) $key->stiches_count;
                        
                            
                         $fileprice = number_format($key->file_price,2) ;
                         $orderdate =$key->order_us_date;
                         $discount = 0 ;
                         $total =    $total  + $fileprice; 
                         $subtotal =  $subtotal + $fileprice; 
                ...
                @endphp
                       ...
                       @php  $fileno=1; @endphp
                        ...
                        {{   number_format($fileprice,2)  }}            </td></tr>
        ...
        <tr>
            ...
            <td style="text-align: right;" class="gray"><b>{{ number_format($total,2) }}</b></td>
        </tr>
        </tfoot>
    </table>
</section>
