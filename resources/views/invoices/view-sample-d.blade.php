...
@foreach($ordersum as $key)
    @php  $totaldue = $totaldue + $key->file_price; @endphp
@endforeach
   ...
   <section class="invoice">
    ...
    <table width="100%" class="detail">
        ...
        <tr>
            ...
            <th style="text-align: left;">File Name</th>
             ...
             <th style="text-align: left;">Order Date</th>
              <th style="text-align: left;">Stitches</th>
        ...
        <tbody>
            ...
            @foreach ($orderlist as $key )
                ...
                @php      
                         ...
                         $fileprice = (float) $key->file_price;
        ...
        <tr>
            ...
            <td align="right" class="gray"><b>{{ number_format($total,2) }}</b></td>
        </tr>
        </tfoot>
    </table>
</section>
