                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody v-if="grouplist.length > 0">
                                <tr v-for="(group,key) in grouplist" :key="key">
                                    ...
                                    <td>
                                        <router-link :to='{name:"groupnotificationEdit",params:{id:group.groupid}}' class="btn btn-success">Edit</router-link>
...
export default {
    ...
    methods:{
        async getgrouplist(){
            await this.axios.get('/api/groupnotification').then(response=>{
